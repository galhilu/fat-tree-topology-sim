...
Purpose: Show how the amount of paralle paths between leaf switches degrades as link failures increase. Graph shows seperatly amount of paths between leafs in the same pod and leafs that are not.
...
Purpose: For different `k`, count how many switches end up with more then 2 failed links when links fail with probability 1%.
...
Purpose: Visualize theoretical host capacity scaling of a k-ary fat-tree.
